...
O repositório \textit{Wiki} concentrou a documentação geral do projeto, servindo de base para o registro de decisões, requisitos, modelos e materiais de apoio. O conteúdo está disponível na \href{https://tools.ages.pucrs.br/weconecta-plataforma-digital-para-question-rios-de-sa-de/wiki/-/wikis/home}{\textit{Wiki} do projeto}.

O repositório \textit{backend} armazenou o código responsável pela API, pela lógica de negócio e pelas integrações do sistema. O código está disponível no \href{https://tools.ages.pucrs.br/weconecta-plataforma-digital-para-question-rios-de-sa-de/backend}{repositório \textit{backend}}.

Por fim, o repositório \textit{frontend} manteve o código da interface do usuário, incluindo telas, componentes e lógica de interação. O código está disponível no \href{https://tools.ages.pucrs.br/weconecta-plataforma-digital-para-question-rios-de-sa-de/frontend}{repositório \textit{frontend}}.



\subsection{Banco de Dados Utilizado}
O projeto WeConecta utilizou o PostgreSQL como sistema gerenciador de banco de dados. Dada a alta complexidade do armazenamento dos dados neste projeto, nosso banco passou por constantes iterações. O esquema inicial proposto pelos AGES II é apresentado na Figura~\ref{fig:db-logical-wecon}.
...
Após algumas \textit{sprints} de desenvolvimento e retornos dos \textit{stakeholders}, o time encerrou o projeto com os esquemas finais conceitual e lógico apresentados nas Figuras~\ref{fig:db-concept-wecon} e~\ref{fig:db-logic-wecon}, respectivamente.
\begin{figure}[H]
  \centering
  \small
