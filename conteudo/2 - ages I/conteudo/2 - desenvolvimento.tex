...
encontrados em: \url{https://tools.ages.pucrs.br/vitimas-de-crime}.
...
OAuth 2 \cite{kotlin,spring-boot,gradle,selenium,keycloak,oauth2}.
...
desenvolvimento \textit{mobile}, enquanto React JS sendo utilizado para \textit{web}
\cite{aws-docs,docker,typescript,react-native,expo,react}.
